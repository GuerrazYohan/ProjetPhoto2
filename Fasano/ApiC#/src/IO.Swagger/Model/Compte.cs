...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Compte :  IEquatable<Compte>, IValidatableObject
    {
        /// <summary>
        ...
        public Compte(string nom = default(string), string prenom = default(string), string motdepasse = default(string), string email = default(string))
        {
            this.Nom = nom;
            this.Prenom = prenom;
        ...
        {
            return this.Equals(input as Compte);
        }

        /// <summary>
        /// Returns true if Compte instances are equal
        /// </summary>
        /// <param name="input">Instance of Compte to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Compte input)
        {
            if (input == null)
                return false;
