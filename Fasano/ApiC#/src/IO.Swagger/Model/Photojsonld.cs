...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Photojsonld :  IEquatable<Photojsonld>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Photojsonld" /> class.
        /// </summary>
        /// <param name="chemindacces">chemindacces.</param>
        /// <param name="rawbytesqr">rawbytesqr.</param>
        public Photojsonld(string chemindacces = default(string), string rawbytesqr = default(string))
        {
        ...
        {
            return this.Equals(input as Photojsonld);
        }

        /// <summary>
        /// Returns true if Photojsonld instances are equal
        /// </summary>
        /// <param name="input">Instance of Photojsonld to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Photojsonld input)
        {
            if (input == null)
                return false;
