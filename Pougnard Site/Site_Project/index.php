  ...
  <div class="container">
    <div class="row">
      <div class="col s12 l8">
        <h5>A propos</h5>
        <p>
          Le but de se site est de permettre à un particulier de louer un objet nommer "PhotoBooth" durant une durée déterminée.
          Il faut d'abbord s'inscrire sur le site pour accéder a votre panneaux de contrôle
          Depuis celui-ci vous aurez accés nous seulement au photos que vous auriez pu prendre durant un événements.
          Ou encore accés à la demande de résérvation de l'appareil.
        </p>
      </div>
